...
namespace OpenLyricsClient.UI.Models.Custom
{
    ...
    public class CustomScrollViewer : ContentControl, IScrollable, IScrollAnchorProvider
    {
        /// <summary>
        ...
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, bool> CanHorizontallyScrollProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, bool>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, bool> CanVerticallyScrollProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, bool>(
        ...
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, Size> ExtentProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, Size>(nameof(Extent),
                o => o.Extent,
                (o, v) => o.Extent = v);
        ...
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, Vector> OffsetProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, Vector>(
                nameof(Offset),
                o => o.Offset,
                (o, v) => o.Offset = v);
        ...
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, Size> ViewportProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, Size>(nameof(Viewport),
                o => o.Viewport,
                (o, v) => o.Viewport = v);
        
        public static readonly DirectProperty<CustomScrollViewer, ScrollDirection> ScrollDirectionProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, ScrollDirection>(nameof(ScrollDirection),
                o => o.ScrollDirection,
                (o, v) => o.ScrollDirection = v);

        /// <summary>
        /// Defines the <see cref="LargeChange"/> property.
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, Size> LargeChangeProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, Size>(
                nameof(LargeChange),
                o => o.LargeChange);
        ...
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, Size> SmallChangeProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, Size>(
                nameof(SmallChange),
                o => o.SmallChange);
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> HorizontalScrollBarMaximumProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> HorizontalScrollBarValueProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> HorizontalScrollBarViewportSizeProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        public static readonly AttachedProperty<ScrollBarVisibility> HorizontalScrollBarVisibilityProperty =
            AvaloniaProperty.RegisterAttached<CustomScrollViewer, Control, ScrollBarVisibility>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> VerticalScrollBarMaximumProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> VerticalScrollBarValueProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        /// <see cref="ScrollContentPresenter"/> in the control's template.
        /// </remarks>
        public static readonly DirectProperty<CustomScrollViewer, double> VerticalScrollBarViewportSizeProperty =
            AvaloniaProperty.RegisterDirect<CustomScrollViewer, double>(
        ...
        /// </summary>
        public static readonly DirectProperty<CustomScrollViewer, bool> IsExpandedProperty =
            ScrollBar.IsExpandedProperty.AddOwner<CustomScrollViewer>(o => o.IsExpanded);

        /// <summary>
        /// Defines the <see cref="AllowAutoHide"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> AllowAutoHideProperty =
            ScrollBar.AllowAutoHideProperty.AddOwner<CustomScrollViewer>();

        /// <summary>
        /// Defines the <see cref="ScrollChanged"/> event.
        /// </summary>
        public static readonly RoutedEvent<ScrollChangedEventArgs> ScrollChangedEvent =
            RoutedEvent.Register<CustomScrollViewer, ScrollChangedEventArgs>(
        ...
        private Vector _oldOffsetValue;
        ...
        {
            HorizontalScrollBarVisibilityProperty.Changed.AddClassHandler<CustomScrollViewer>((x, e) => x.ScrollBarVisibilityChanged(e));
            VerticalScrollBarVisibilityProperty.Changed.AddClassHandler<CustomScrollViewer>((x, e) => x.ScrollBarVisibilityChanged(e));
        }
        ...
        {
            this._oldOffsetValue = new Vector();
        ...
        public Vector Offset
        {
            ...
            set
            {
                Vector vector = CoerceOffset(Extent, Viewport, value);

                RaisePropertyChanged(OffsetProperty, Offset, value);

                if (SetAndRaise(OffsetProperty, ref _offset, vector))
                {
        ...
        public void RaiseScrollChanged()
        {
